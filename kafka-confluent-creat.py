...
def main():
    ...
    parser.add_argument('--max_message_bytes', type=int, help='Política de limpeza', default=None)
    parser.add_argument('--num_partitions', type=int, help='Número de partições', default=None)
    parser.add_argument('--replication_factor', type=int, help='Fator de replicação', default=None)
